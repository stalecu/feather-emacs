...
;; This is the early init file for Feather Emacs. This is the file
;; that gets run before init.el, and as such this file contains some
;; optimizations, mainly related to GC, startup speed and UI, as well
;; as disabling package.el at startup.
